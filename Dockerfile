...
RUN apt-get update && apt-get install -y --no-install-recommends maven && \
	...
	mv /root/.m2/repository/fr/inra/toulouse/metexplore/PathwayEnrichment/1.0.2/PathwayEnrichment-1.0.2-jar-with-dependencies.jar /pathwayEnrichment.jar && \
	cd / && rm -rf Javafiles
